...
describe('Transforma la ruta si no es absoluta', () => {
  it('Ruta absoluta', () => {
    expect(validate.transformaRuta('C:/Users/gatic/Documents/Bootcamp/Proyecto3/DEV011-md-links/markdown2.md')).toMatch('C:/Users/gatic/Documents/Bootcamp/Proyecto3/DEV011-md-links/markdown2.md');
  });  
  it('Ruta relativa', () => {
...
describe('Valida si la ruta existe', () => {
  it('Sí existe la ruta', () => {
    expect(validate.existeRuta('C:/Users/gatic/Documents/Bootcamp/Proyecto3/DEV011-md-links/markdown2.md')).toBe(true);
  });
  it('No existe la ruta', () => {
    console.log(validate.transformaRuta('markdown.md'));
    expect(validate.existeRuta('C:/Users/gatic/Documents/Bootcamp/Proyecto3/DEV011-md-links/markdownFake.md')).toBe(false);
  });
